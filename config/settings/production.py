...
ALLOWED_HOSTS = env.list(
    "DJANGO_ALLOWED_HOSTS", default=["learningmanager.com"]
)
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="LearningManager <noreply@learningmanager.com>",
)
...
EMAIL_SUBJECT_PREFIX = env(
    "DJANGO_EMAIL_SUBJECT_PREFIX", default="[LearningManager]"
)
